...
export function AppDownload() {
  return (
    ...
    >
      <div className="cyber-glass-strong relative mx-auto max-w-5xl overflow-hidden rounded-3xl px-8 py-24 shadow-[0_0_0_1px_rgba(34,211,238,0.12),0_44px_140px_-70px_rgba(34,211,238,0.22)] sm:px-16 sm:py-28">
        <div
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          >
            Satokey is available on iOS and Android. Your Smart Vault companion—always with you.
          </motion.p>
